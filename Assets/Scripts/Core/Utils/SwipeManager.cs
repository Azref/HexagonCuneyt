...
/// Original code is changed by Cuneyt Taşkent according to needs like: firstPressPos and secondPressPos
/// </summary>
public class SwipeManager : MonoBehaviour
{
    ...
    public delegate void OnSwipeDetectedHandler(Swipe swipeDirection, Vector2 swipeVelocity, Vector2 firstPressPos, Vector2 secondPressPos);
    ...
    static void DetectSwipe ()
    {
        if (GetTouchInput() || GetMouseInput()) {
            ...
            if (_OnSwipeDetected != null) {
                _OnSwipeDetected(swipeDirection, swipeVelocity, firstPressPos, secondPressPos);
            }
        } else {
            swipeDirection = Swipe.None;
        }
